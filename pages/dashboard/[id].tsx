    ...
    return (
        <div className={styles.container} style={{ position: 'relative' }}>
            <div style={{
                ...
                <div style={{ fontWeight: 'bold', marginBottom: '0.5rem', color: '#333' }}>Nawigacja</div>
                {data.status === 'completed' && (
                    <>
                        {pages404.length > 0 && <a href="#section-404" style={{ textDecoration: 'none', color: '#d32f2f' }}>⚠ Błędy 404</a>}
                        <a href="#section-titles" style={{ textDecoration: 'none', color: '#666' }}>Analiza tytułów</a>
                        <a href="#section-domain" style={{ textDecoration: 'none', color: '#666' }}>Info o domenie</a>
                        <a href="#section-summary" style={{ textDecoration: 'none', color: '#666' }}>Podsumowanie</a>
                        {data.redirects && <a href="#section-redirects" style={{ textDecoration: 'none', color: '#666' }}>Przekierowania</a>}
                        <a href="#section-pages" style={{ textDecoration: 'none', color: '#666' }}>Strony</a>
                        <a href="#section-meta" style={{ textDecoration: 'none', color: '#666' }}>Opisy Meta</a>
                        <a href="#section-images" style={{ textDecoration: 'none', color: '#666' }}>Obrazy</a>
                        <a href="#section-recs" style={{ textDecoration: 'none', color: '#0070f3', fontWeight: 'bold' }}>★ Zalecenia</a>
                    </>
                )}
            </div>
                ...
                {visibleItems.map((item: any, idx: number) => (
                    <li key={idx} style={{ marginBottom: '0.25rem' }}>
                        {item.startsWith && item.startsWith('http') ? (
                            <a href={item} target="_blank" rel="noopener noreferrer" style={{ color: '#0070f3', textDecoration: 'none' }}>
                                {item}
                            </a>
                        ) : item}
                    </li>
